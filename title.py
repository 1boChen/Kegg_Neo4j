...
if __name__ == '__main__':
    ...
    print(entry_dict['hsa:672'])



    #try find in dictionary, except not found, try url, else missing

    # i = pathway_list.index('hsa01040')
    # new_pathway_list = pathway_list[i + 2:]
    # get_pathway(pathway_list)
